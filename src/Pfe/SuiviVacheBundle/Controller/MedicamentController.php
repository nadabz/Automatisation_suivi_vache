...
class MedicamentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $medicaments = $em->getRepository('PfeSuiviVacheBundle:Medicament')->findAll();

        return $this->render('@PfeSuiviVache/medicament/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Pfe\SuiviVacheBundle\Form\MedicamentType', $medicament);
        ...
        return $this->render('@PfeSuiviVache/medicament/new.html.twig', array(
    ...
    public function showAction(Medicament $medicament)
    {
        ...
        return $this->render('@PfeSuiviVache/medicament/show.html.twig', array(
            'medicament' => $medicament,
    ...
    {
        $deleteForm = $this->createDeleteForm($medicament);
        $editForm = $this->createForm('Pfe\SuiviVacheBundle\Form\MedicamentType', $medicament);
        ...
        return $this->render('@PfeSuiviVache/medicament/edit.html.twig', array(
            'medicament' => $medicament,
