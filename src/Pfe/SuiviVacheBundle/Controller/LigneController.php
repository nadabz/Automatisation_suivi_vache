...
use Pfe\SuiviVacheBundle\Entity\Ligne;
...
class LigneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $lignes = $em->getRepository('PfeSuiviVacheBundle:Ligne')->findAll();
    ...
    {
        $ligne = new Ligne();
        $form = $this->createForm('Pfe\SuiviVacheBundle\Form\LigneType', $ligne);
    ...
    {
        $deleteForm = $this->createDeleteForm($ligne);
        $editForm = $this->createForm('Pfe\SuiviVacheBundle\Form\LigneType', $ligne);
